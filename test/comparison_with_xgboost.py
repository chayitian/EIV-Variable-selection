...
def parse_args():
    parser = argparse.ArgumentParser(description='综合对比测试（含XGBoost）')
...
def main():
    ...
    plot_comparison(
        ...
        save_path=os.path.join(save_dir, 'alpha_comparison_xgb_{}.png'.format(timestamp)),
        colors=colors,
    ...
    plot_comparison(
        ...
        save_path=os.path.join(save_dir, 'p_comparison_xgb_{}.png'.format(timestamp)),
        colors=colors,
        marker_map=marker_map,
    )
    ...
    plot_comparison(
        ...
        save_path=os.path.join(save_dir, 'n_comparison_xgb_{}.png'.format(timestamp)),
        colors=colors,
        marker_map=marker_map,
    )
    ...
    plot_comparison(
        ...
        save_path=os.path.join(save_dir, 'sigma_u_comparison_xgb_{}.png'.format(timestamp)),
        colors=colors,
        marker_map=marker_map,
    )
    ...
    with open(os.path.join(save_dir, 'all_results_xgb_{}.pkl'.format(timestamp)), 'wb') as f:
