...
def plot_radar_chart(results, save_path):
    ...
    ax.set_ylim(0, 1)
    ax.set_title('Model Performance Comparison (with RandomForest)', fontsize=16, fontweight='bold')
...
def main():
    ...
    plot_radar_chart(default_results, os.path.join(save_dir, f'radar_comparison_rf_{timestamp}.png'))
