...
from src.models.eiv.canonical import CLasso, CoCoElasticNet, CoCoLasso
...
def build_model(method_name, alpha, sigma_uu, init_coef=None):
    ...
    if method_name == 'CoCoElasticNet':
        return CoCoElasticNet(alpha=alpha, l1_ratio=0.5, Sigma_uu=sigma_uu)
...
def main():
    ...
    print('=' * 90)
    print('CoCoElasticNet reproduction started')
    ...
    for exp_idx, exp in enumerate(experiments):
        ...
        for struct_idx, (struct_key, struct_label) in enumerate(structures):
            ...
            csv_path = output_dir / f"CoCoElasticNet_{exp['name']}_{struct_label}.csv"
