...
class CoCoLasso:
    ...
    def __init__(self, alpha=1.0, Sigma_uu=None, max_iter_admm=1000, tol_admm=1e-4, rho=1.0):
        ...
        ### 新增诊断字段，不改变原有 fit/predict 接口，用于论文中的收敛与稳定性报告
        self.fit_time_ = None
    ...
    def _project_psd(self, M):
        ...
        ### 记录 ADMM 收敛轨迹，便于后续分析不同参数下的收敛稳定性
        step_norm_history = []
